...
let g:coc_global_extensions = ['coc-tabnine', 'coc-stylelint','coc-emoji', 'coc-eslint', 'coc-prettier', 'coc-tsserver', 'coc-tslint-plugin','coc-css', 'coc-json', 'coc-pyright','coc-markmap','coc-snippets' ,'coc-emmet','coc-html']
